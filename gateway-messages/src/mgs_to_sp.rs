...
pub struct EreportRequest {
    ...
    /// The reporter instance ID (restart nonce) of the SP's snitch task which
    /// MGS believes is current.
    ///
    ...
    ///
    /// If MGS does not know the SP's generation, this will be 0. Nonces
